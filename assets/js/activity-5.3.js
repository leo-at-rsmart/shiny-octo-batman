...
var activity = [
    ...
    'In order to get the copy of the project that you will need, please check out the <b>exercise-kew-kim-routing</b> project from the training Subversion repository.',
    ...
    'Most importantly, the value of the <code>srvc_nm</code> column contains a service name which must point to a service that implements the <code>KimRoleTypeService</code> interface.  This can be used to customize the behavior of various aspects of the role.  Although, as you will see later, we will simply use the default implementation of the role type service for this exercise.',
